...
<form>
	...
	<div class="form-inline">
		...
		<div class="form-group">
			<label for="horario_saida">Horário da Saída <em>*</em></label>
			<input type="text" class="form-control" id="horario_saida" placeholder="08:00">
		</div>
	</div>


	<div class="botao_submit sem_margem">
		<button type="submit" class="btn btn-default checkout">Confirmar Check-Out</button>
	</div>
